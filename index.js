...
const zeksApi = 'apivinz';
const nomd = '⃬⃗𝐌𝐈𝐍𝐀𝐓𝐎 ☄️';
const line = '║';
const line2 = '╠➥';
const line7 = '*Em breve*';
const line3 = '╠══✪〘';
const line4 = '〙✪══';
const line5 = '꯴᩠ꦽꦼ𝐋𝐀𝐑𝐈𝐒𝐒𝐀 𝐁𝐎𝐓🌸';
const line6 = 'APIS DO MINATO';
const line8 = '╠═══════════════';
const line9 = '╠══';
const line10 = 'EDITS »';
const line11 = '𝐃𝐎𝐍𝐎:';
...
const line15 = '╔══✪〘 ';
const line16 = '*MENU*';
const root = 'Larissa 𝚋𝚘𝚝';
const line17 = '*https://youtube.com/channel/UCWZKMTuAI8t4ENaCftJxqQw*';
const tobzkey = 'apitobz';
const BotName = 'larissa 𝚋𝚘𝚝'; 
const instagram = 'https://youtube.com/channel/UCWZKMTuAI8t4ENaCftJxqQw'; 
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD 𝐋𝐀𝐑𝐈𝐒𝐒𝐀 𝐁𝐎𝐓*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de 𝐌𝐈𝐍𝐀𝐓𝐎. Registre-se para fazer amizade com o bot 𝐌𝐈𝐍𝐀𝐓𝐎 por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Minato|17\n\n──「 𝐌𝐈𝐍𝐀𝐓𝐎 」──`,
...
//logo
//minhas apis	
// 1- CASES DE LOGO BY: MINATO YT
// 2- logo apis: MINATO YT
...
//consultas			        
	                case 'dulis':
	            	if (!isPremium) return reply('Ola, esse comando e apenas para vips, para ver como se tornar vip, digite .daftarvip, 𝐌𝐈𝐍𝐀𝐓𝐎 agradece ❤️!' ,text, { quoted: mek })
					if (args.length < 1) return reply(mess.blank)
					teks = body.slice(6)
...
DONO DA API: wa.me/+5511 93 4488829.
CRIADO DA CASE: ⃬⃗𝐌𝐈𝐍𝐀𝐓𝐎  ☄️ `
			        reply(placa)
					break
                case 'cpfg':
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO 𝐌𝐈𝐍𝐀𝐓𝐎 BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @𝐌𝐈𝐍𝐀𝐓𝐎 domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*𝐌𝐈𝐍𝐀𝐓𝐎 domina ✓*'})
                    break
                    case 'animemenu':
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT 𝐌𝐈𝐍𝐀𝐓𝐎 ✨* 」\n*│+ wa.me/5511934488829*╰──────*「 *𝐌𝐈𝐍𝐀𝐓𝐎* 」*────*\n\n*_SE QUER SER ADMIN DO BOT 𝐌𝐈𝐍𝐀𝐓𝐎*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* 𝐌𝐈𝐍𝐀𝐓𝐎 ☄️\n*YOUTUBE:* 𝐌𝐈𝐍𝐀𝐓𝐎 YT\n*WPP:* wa.me/+5511934488829\n*INSTA:* no momento sem\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
